...
public class ProblemOfUsingDirectionTests {
     ...
     *   1. 데이터 변환, SQL 작성, JDBC 코드 중복 작성 => 개발 시간 증가 => 유지보수성 악화
     *   2. SQL 의존적인 개발
     *   3. 패러다임 불일치
     *   4. 동일성 보장 문제
     *  */
    ...
    void testDirectSQL() throws SQLException {
        ...
        /* 필기.
         *   Assertions 클래스는 우리가 작성한 테스트 코드의 검증을 할 수 있는 기능(메소드)를
         *   제공해주는 Class 이다.
         *  */
    ...
    void testInsertSQL() throws SQLException {
        ...
        // then
        /* equals : 메소드는 실제 값과 기대하는 값의 일치 여부를 동일성으로 판단한다. */
     ...
     *   DB 수정, SQL문 수정, Application 수정 등의 문제 발생
     *  */
    ...
    void testAssociatedObject() throws SQLException {
        ...
        menuAndCategoryList.forEach(menu -> System.out.println(menu));
    ...
    /* 객체지향에서 말하는 1 대 1 관계 1 대 다 관계는 데이터베이스 저장 구조와 다른 형태이다. */
